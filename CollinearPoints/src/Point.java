...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        ...
        if ((int)deltax == 0) return 0.0;
        double deltay = that.y - this.y;
        if ((int)deltay == 0) return Double.POSITIVE_INFINITY;
    ...
    public int compareTo(Point that) {
        if ((y < that.y) || (y == that.y && x < that.y)) return -1;
    ...
    public static void main(String[] args) {
        ...
        if (p1.compareTo(p2) == 1) System.out.printf("p1 < p2");
        else System.out.printf("p2 < p1");
    }
}
